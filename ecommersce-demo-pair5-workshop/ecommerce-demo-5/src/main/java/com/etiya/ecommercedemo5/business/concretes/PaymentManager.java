...
public class PaymentManager implements PaymentService {
    ...
    public DataResult<List<Payment>> getAll() {
        ...
        return new SuccessDataResult<List<Payment>>(response, messageSource.getMessage(Messages.Payment.getAllPayment,null,LocaleContextHolder.getLocale()));
    }

    @Override
    public DataResult<Payment> getById(int id) {
        Payment response = this.paymentRepository.findById(id).orElseThrow();
        return new SuccessDataResult<Payment>(response,messageSource.getMessage(Messages.Payment.getByPaymentId,null,LocaleContextHolder.getLocale()));
    }
    ...
    public DataResult<AddPaymentResponse> addPayment(AddPaymentRequest addPaymentRequest) {
        ...
        return new SuccessDataResult<AddPaymentResponse>(addPaymentResponse, messageSource.getMessage(Messages.Payment.addPayment,null,LocaleContextHolder.getLocale()));
    }
