...
public class CustomerManager implements CustomerService {
    ...
    public DataResult<List<Customer>> getAll() {
        ...
        return new SuccessDataResult<List<Customer>>(response);
    }

    @Override
    public DataResult<Customer> getById(int id) {
        Customer response = this.customerRepository.findById(id);
        return new SuccessDataResult<Customer>(response);
    }
    ...
    public DataResult<AddCustomerResponse> addCustomer(AddCustomerRequest addCustomerRequest) {
        ...
        return new SuccessDataResult<AddCustomerResponse>(addCustomerResponse);
    ...
    public DataResult<Page<Customer>> findAllWithPagination(Pageable pageable) {
        ...
        return new SuccessDataResult<Page<Customer>>(response);
    }
